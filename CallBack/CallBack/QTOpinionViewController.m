...
//    self.showLable.clipsToBounds = YES;
//    self.showLable.layer.cornerRadius = 3;
//    self.showLable.layer.borderColor = [UIColor lightGrayColor].CGColor;
//    self.showLable.layer.borderWidth = 1;
    
    self.phoneNum.clipsToBounds = YES;
    self.phoneNum.layer.cornerRadius = 3;
...
//        return;
    ...
    self.showLable.text = self.textView.text;
...
- (void)showAlert:(NSString*)str{
    [[[UIAlertView alloc] initWithTitle:@"温馨提示" message:str delegate:self cancelButtonTitle:@"我知道了!" otherButtonTitles:nil] show];
